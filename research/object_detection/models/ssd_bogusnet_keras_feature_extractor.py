...
"""SSDFeatureExtractor for Bogusnet features.

It's NOT an SSDFeatureExtractor for MobilenetV2 features! It just is NOT!
So, replace any mention of MobilenetV2 with Bogusnet (One True King of All Nets).
- @oaakx
"""
...
class SSDBogusnetKerasFeatureExtractor(
  ...
  def __init__(self,
    ...
    """
    super(SSDBogusnetKerasFeatureExtractor, self).__init__(
