...
MODEL_NAME=ssdlite_mobilenet_v1_coco_2020_07_01
INPUT_TYPE=image_tensor
PIPELINE_CONFIG_PATH=./object_detection/coco_data/ssdlite_mobilenet_v1.config
TRAINED_CKPT_DIR_PATH=./object_detection/coco_data/model_dir_${MODEL_NAME}
...
EXPORT_DIR=./object_detection/coco_data/frozen_model_${MODEL_NAME}
